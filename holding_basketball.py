...
class BallHoldingDetector:
    ...
    def process_frame(self, frame):
        ...
        # rounded_results = np.round(pose_results[0].keypoints.numpy().astype([('x', '<f8'), ('y', '<f8'), ('score', '<f8')]), 1)
        ...
        try:
            ...
            left_wrist = data[0][self.body_index["left_wrist"]]
            right_wrist = data[0][self.body_index["right_wrist"]]
        except:
